...
// Move soldierColors outside the component to avoid dependency issues
const soldierColors = [
    "#00FF00",  // Pure Green
    "#0000FF",  // Pure Blue
    "#FFFF00",  // Pure Yellow
...
export default function MapSection({ soldiers = [], selectedSoldierId }) {
  ...
  // Removed unused defaultZoomLevel state
  ...
  // Wrapped generateColorFromId in useCallback to fix dependency warnings
  ...
  }, []); // Empty dependency array since it only depends on the static soldierColors array
            ...
            try {
              ...
              if (metadata.bounds) {
                ...
                if (bounds.length === 4) {
                  ...
                  // Removed setDefaultZoomLevel since it was unused
  ...
  }, [soldiers, generateColorFromId]); // Added generateColorFromId to dependencies
  ...
  }, [soldiers, colorMap, outOfBoundsSoldiers, generateColorFromId]); // Added generateColorFromId to dependencies
  ...
  }, [soldiers, trailsData, selectedSoldierId, colorMap, outOfBoundsSoldiers, showPathTracking, generateColorFromId]); // Added generateColorFromId to dependencies
