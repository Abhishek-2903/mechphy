...
import ReplaySidebar from "../components/ASidebar";
import ReplayKillFeed from "../components/AKillFeed";
import ReplayStatsTable from "../components/AStatsTable";

// Dynamically import ReplayMapSection to avoid SSR issues
const ReplayMapSection = dynamic(
  () => import("../components/AMapSection"),
  { ssr: false }
);
  ...
  const handleLoadReplay = async () => {
    ...
    try {
      const response = await fetch(
        `/api/historical?start=${startTimestamp}&end=${endTimestamp}`
      );
